...
void color1(int n,double output[3]){
	double bright = 360.0*n/maxiter;//map(n,0,maxiter,360.0,0.0);
	double tempv = v;
	if(n>=maxiter){
		tempv = 0;
	}
...
void color2(int n,double output[3]){
	double bright = 360.0-(360.0*n/maxiter);//map(n,0,maxiter,360.0,0.0);
	double tempv = v;
	if(n>=maxiter){
		tempv = 0;
	}
...
void color3(int n,double output[3]){
	//double bright = 180.0+(60.0*n/maxiter);//map(n,0,maxiter,360.0,0.0);
